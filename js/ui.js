...
function toggleLoading(isLoading) {
  ...
  if (isLoading === true){
    document.getElementById("searchElement").className = "fas fa-hourglass-half";
    ...
    searchingButton.removeChild(searchingButton.lastChild);
    
    searchingButton.appendChild(textNode);
  }
  else if (isLoading === false){
    document.getElementById("searchElement").className = "fa fa-search";
    let searchButtonTwo = document.querySelector("#searchButton");
    searchButtonTwo.disabled = false;
    var textNode = document.createTextNode("  Search");
    
    searchButtonTwo.removeChild(searchButtonTwo.lastChild);
    
    searchButtonTwo.appendChild(textNode);
  }
}
